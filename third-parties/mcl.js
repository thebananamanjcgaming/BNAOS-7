...
function generateprofile(game) {
    ...
    let running = false;
    if (!selectedGame1) {
        fetch("https://bna-launcher.vercel.app/assets/json/base.json").then((response) => response.json()).then((data) => {
    ...
    if (!selectedGame2) {
        fetch("https://bna-launcher.vercel.app/assets/json/modded.json").then((response) => response.json()).then((data) => {
    ...
    if (!selectedGame3) {
        fetch("https://bna-launcher.vercel.app/assets/json/assisted.json").then((response) => response.json()).then((data) => {
    ...
    fetch(path).then((response) => response.json()).then((data) => {
        ...
        data.forEach((game) => {
            ...
            gameoption.addEventListener("click", () => {
                ...
                if (path === "https://bna-launcher.vercel.app/assets/json/assisted.json") {selectedGame3 = JSON.stringify(game); localStorage.setItem("assisted", selectedGame3)};
                dropdowntoggle();
            });
...
function generatemods() {
    fetch("https://bna-launcher.vercel.app/assets/json/mods.json").then((response) => response.json()).then((data) => {
        data.forEach((mod) => {
...
function generatefaqs() {
    fetch("https://bna-launcher.vercel.app/assets/json/faqs.json").then((response) => response.json()).then((data) => {
        data.forEach((game) => {
...
function generatenotes() {
    fetch("https://bna-launcher.vercel.app/assets/json/patchnotes.json").then((response) => response.json()).then((data) => {
        data.forEach((note) => {
            ...
            patchnoteimg.src = "https://bna-launcher.vercel.app/assets/images" + note.icon;
...
let launcher = "https://bna-launcher.vercel.app/assets/json/base.json";
function webedition(){
    launcher = "https://bna-launcher.vercel.app/assets/json/base.json";
    resetTabSelected();
    generateprofile(1);
    generategames(launcher);
    generatelaunchers(launcher);
    document.getElementById('game-bg').style.backgroundImage = 'url(https://bna-launcher.vercel.app/assets/images/web-edition.jpg)';
...
function moddededition(){
    launcher = "https://bna-launcher.vercel.app/assets/json/modded.json";
    resetTabSelected();
    generateprofile(2);
    generategames(launcher);
    generatelaunchers(launcher);
    document.getElementById('game-bg').style.backgroundImage = 'url(https://bna-launcher.vercel.app/assets/images/modded-edition.jpg)';
    document.getElementById('game-title').src = 'https://bna-launcher.vercel.app/assets/images/modded-title.png';
...
function eaglercontrols(){
    launcher = "https://bna-launcher.vercel.app/assets/json/assisted.json";
    resetTabSelected();
    generateprofile(3);
    generategames(launcher);
    generatelaunchers(launcher);
    document.getElementById('game-bg').style.backgroundImage = 'url(https://bna-launcher.vercel.app/assets/images/controls-edition.jpg)';
...
generateprofile(1);
generategames("https://bna-launcher.vercel.app/assets/json/base.json");
generatefaqs();
